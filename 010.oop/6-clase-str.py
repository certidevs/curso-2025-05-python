...
# Método __str__ para obtener la representación textual
print(ford_mondeo)
print(fiat_multipla)

# Método __repr__ para obtener la representación textual cuando se trabaja con estructuras de datos
cars = [ford_mondeo, fiat_multipla]
print(cars)
